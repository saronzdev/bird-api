...
import {saronzreq} from './modules/info.module.js'
...
app.use(express.static(path.join(process.cwd(), 'public')), saronzreq, cors(), express.json(), express.urlencoded({extended: false}))
app.use(connectDB)
